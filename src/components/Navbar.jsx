...
const Navbar = () => {
    ...
    <div className='z-10 fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#212D40]'>
        ...
        <ul className='hidden md:flex'>
            <li><Link to="home" offset={-80} smooth={true} duration={500}>Home</Link></li>
        ...
        <ul className={nav ?'mobile-menu absolute top-0 left-0 w-full h-screen bg-[#1e3751] flex flex-col items-center justify-center':'hidden'}>
            <li><Link onClick={toggleNav} offset={-80} to="home" spy={true} smooth={true} duration={500}>Home</Link></li>
